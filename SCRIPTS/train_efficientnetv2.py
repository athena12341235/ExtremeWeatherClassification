...
Usage:
  ...
  python SCRIPTS/train_efficientnetv2.py \
  ...
  python SCRIPTS/train_efficientnetv2.py \
      --split-root dataset_split --gradcam_mobilenetv2 --gradcam_mobilenetv2-samples 12 --arch v2_s

  # Dry-run to sanity-check a forward/backward step
  python SCRIPTS/train_efficientnetv2.py --dry-run --limit-per-class 8 --num-workers 0 --arch v2_s
"""
